...
func TestCreateWithInvalidParent(t *testing.T) {
	...
	if err := d.Create("1", "docker", "", true); err == nil {
...
func TestGetDiff(t *testing.T) {
	...
	if err := d.Create("1", "", "", false); err != nil {
		t.Fatal(err)
	}
...
func TestChanges(t *testing.T) {
	...
	if err := d.Create("2", "1", "", false); err != nil {
		t.Fatal(err)
	}
	...
	if err := d.Create("3", "2", "", false); err != nil {
		t.Fatal(err)
	}
...
func TestApplyDiff(t *testing.T) {
	...
	if err := d.Create("2", "", "", true); err != nil {
		t.Fatal(err)
	}
	if err := d.Create("3", "2", "", true); err != nil {
		t.Fatal(err)
	}
...
func testMountMoreThan42Layers(t *testing.T, mountPath string) {
	...
	for i := 1; i < 127; i++ {
		...
		if err := d.Create(current, parent, "", false); err != nil {
