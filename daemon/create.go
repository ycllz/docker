...
// ContainerCreate is the parameter set to ContainerCreate()
...
func (daemon *Daemon) ContainerCreate(params *ContainerCreate) (types.ContainerCreateResponse, error) {
...
func create(daemon *Daemon, params *ContainerCreate) (retC *Container, retS []string, retErr error) {
	var (
		container *Container
		warnings  []string
		img       *image.Image
