...
// Const for time stamp
const TimeStart = "00 Jan 01 00:00 UTC"
var oldTime time.Time

// VHDHeader is the footer for a fixed VHD
...
func NewVHDHeaderFixed(size uint64) (*VHDHeader, error) {
    header := NewVHDHeader()
...
func CalculateCheckSum(header *VHDHeader) (uint32, error) {
